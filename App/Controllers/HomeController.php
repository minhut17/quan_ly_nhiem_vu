...
class HomeController extends BaseController
{
    ...
    {
        // $users = $this->load->renderModel('User');
    ...
    function homePage()
    {
        ...
        if (isset($_SESSION['user'])) {
            ...
            $statistical = new Task();
            $data = $statistical->thongKeNhiemVu($id_user);
    ...
    function register()
    {
        ...
        $this->load->render('componest/register',$data);
    }
