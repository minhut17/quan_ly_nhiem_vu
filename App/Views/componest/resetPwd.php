    ...
    <div class="card-body register-card-body">
      ...
      <form action="" method="post">
        ...
        <div class="row">
          ...
          <div class="col-12">
            <button type="submit" name="resetPwd" class="btn btn-primary btn-block">Đổi Mật Khẩu</button>
          </div>
          <!-- /.col -->
        </div>
        <div class="mt-3">
...
<!-- 
<form  id="doimatkhau" action="" method="post">
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="pass1" class="form-control" id="pass1" name="pass1" >
                        </div>
                        <div class="mb-3">
                            <label for="pass2" class="form-label">Xác Nhạn Mật Khẩu</label>
                            <input type="pass2" class="form-control" id="pass2" name="pass2" >
                        </div>

                        <div class="d-grid gap-2">
                            <button type="submit" name="resetPwd" class="btn btn-primary">Đổi Mặt Khẩu</button>
